...
describe("UserDAO tests:", () => {
	...
	describe("getIsUserAuthenticathed tests:", () => {
		...
		test("It should reject Error", async () => {
			...
			const result = userDAO.getIsUserAuthenticated(
				"username",
				"plainPassword"
			);
		...
		test("It should reject error", async () => {
			...
			try {
				await userDAO.getIsUserAuthenticated(
					"username",
					"plainPassword"
				);
			} catch (e) {
	...
	describe("getUserByRole tests:", () => {
		test("It should resolve users", async () => {
			...
			const result = await userDAO.getUserByRole(Role.CUSTOMER);
			expect(result).toStrictEqual(users);
			mockDBAll.mockRestore();
		});
	...
	describe("updateUserInformation tests:", () => {
		test("It should resolve user", async () => {
			...
			const result = await userDAO.updateUserInformation(
				"name",
				"surname",
				"address",
				"birthdate",
		...
		test("It should reject Error", async () => {
			...
			const result = userDAO.updateUserInformation(
				"name",
				"surname",
				"address",
				"birthdate",
		...
		test("It should reject error", async () => {
			...
			try {
				await userDAO.updateUserInformation(
					"name",
					"surname",
					"address",
					"birthdate",
