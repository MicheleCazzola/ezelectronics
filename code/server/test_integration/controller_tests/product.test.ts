...
describe("ProductController test:", () => {
    ...
    describe("registerProduct test", () => {
        ...
        test("Register a new product withouth an arrival date", async () => {
            ...
            const testProduct  = new Product(12, "TestModel", Category.SMARTPHONE, "", "TestDetails", 12); 
    ...
    describe("productByModel test:", () => {
        ...
        test("it should return an error if the product searched does not exists", async () => {
            ...
            await expect(productController.productByModel("UnkownModel")).rejects.toThrow(new ProductNotFoundError());
    ...
    describe("changeProductQuantity test:", () => {
        ...
        test("It should return the quantity changed", async () => {
            ...
            const result = await productController.changeProductQuantity(testProduct.model, newQuantity, todayDate);
        ...
        test("the arrival date must to be before or equal the today date", async () => {
            ...
            await expect(productController.changeProductQuantity(testProduct.model, newQuantity, pastDate)).rejects.toThrow(new DateError());
    ...
    describe("sellProduct test:", () => {
        ...
        test("It should return the quantity changed after the sell", async () => {
            ...
            const result = await productController.sellProduct(testProduct.model, soldQuantity, todayDate);
        ...
        test("the selling date must to be before or equal the today date", async () => {
            ...
            await expect(productController.sellProduct(testProduct.model, soldQuantity, pastDate)).rejects.toThrow(new DateError());
    ...
    describe("getProducts test:", () => {
        ...
        test("Return all products filtered by model", async () => {
           ...
           const result = await productController.getProducts("model", "", "TestModel1");
        ...
        test("Return all products filtered by model - failure (product does not exist) ", async () => {
           ...
           await expect(productController.getProducts("model", "", "TestModel6")).rejects.toThrow(new ProductNotFoundError());
        ...
        test("Return all products filtered by category", async () => {
           ...
           const result = await productController.getProducts("category", "Smartphone", "");
    ...
    describe("getAvailableProducts test:", () => {
        ...
        test("Return all available products ", async () => {
            ...
            const testProduct1  = new Product(12, "TestModel1", Category.SMARTPHONE, "2024-04-02", "TestDetails", 10);
            const testProduct2  = new Product(12, "TestModel2", Category.LAPTOP, "2024-04-02", "TestDetails", 10);
            const testProduct3  = new Product(12, "TestModel3", Category.APPLIANCE, "2024-04-02", "TestDetails", 0);
        ...
        test("Return all available products filtered by model", async () => {
            ...
            const testProduct1  = new Product(12, "TestModel1", Category.SMARTPHONE, "2024-04-02", "TestDetails", 10);
            const testProduct2  = new Product(12, "TestModel2", Category.LAPTOP, "2024-04-02", "TestDetails", 10);
            const testProduct3  = new Product(12, "TestModel3", Category.SMARTPHONE, "2024-04-02", "TestDetails", 0);
           ...
           const result = await productController.getAvailableProducts("model", "", "TestModel1");
        ...
        test("Return all available products filtered by model - absent", async () => {
            ...
            const testProduct1  = new Product(12, "TestModel1", Category.SMARTPHONE, "2024-04-02", "TestDetails", 0);
            const testProduct2  = new Product(12, "TestModel2", Category.LAPTOP, "2024-04-02", "TestDetails", 10);
            const testProduct3  = new Product(12, "TestModel3", Category.APPLIANCE, "2024-04-02", "TestDetails", 0);
        ...
        test("Return all available products filtered by model - failure (product does not exist) ", async () => {
           ...
           await expect(productController.getAvailableProducts("model", "", "TestModel6")).rejects.toThrow(new ProductNotFoundError());
    ...
    describe("deleteProduct test:", () => {
        ...
        test("it should delete the specified Product ", async () => {
          ...
          await expect(productController.productByModel(deletedModel)).rejects.toThrow(new ProductNotFoundError());
