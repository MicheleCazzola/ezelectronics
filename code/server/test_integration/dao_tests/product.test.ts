...
describe("ProductDAO tests:", () => {
  ...
  describe("getProductByModel tests", () => {
    ...
    test("if model does not exist it should trhow an error", async () => {
      ...
      await expect(productDAO.getProductByModel("Unknown")).rejects.toThrow(
        err
      );
    });
  });
  ...
  describe("increaseQuantity Test:", () => {
    ...
    test("it should increase the quantity of a selected product", async () => {
      ...
      const result = await productDAO.increaseQuantity(
        testProduct.model,
        newQuantity,
        todayDate
      );
    ...
    test("The changeDate has to be after the arrivalDate", async () => {
      ...
      await expect(
        productDAO.increaseQuantity(testProduct.model, newQuantity, pastDate)
      ).rejects.toThrow(err);
    });
    ...
    test("if model does not exist it should trhow an error", async () => {
      ...
      await expect(
        productDAO.increaseQuantity("Unknown", 10, "2024-04-04")
      ).rejects.toThrow(err);
    });
  });
  ...
  describe("decreaseQuantity test:", () => {
    ...
    test("it should return the new quantity after the decrease", async () => {
      ...
      const result = await productDAO.decreaseQuantity(
        testProduct.model,
        soldQuantity,
        todayDate
      );
    ...
    test("The sellingDate has to be after the arrivalDate", async () => {
      ...
      await expect(
        productDAO.decreaseQuantity(testProduct.model, soldQuantity, pastDate)
      ).rejects.toThrow(err);
    });
    ...
    test("The quantity to sell cant be greater than the available quantity", async () => {
      ...
      await expect(
        productDAO.decreaseQuantity(testProduct.model, soldQuantity, date)
      ).rejects.toThrow(err);
    });
    ...
    test("if model does not exist it should trhow an error", async () => {
      ...
      await expect(
        productDAO.decreaseQuantity("Unknown", 10, "2024-04-04")
      ).rejects.toThrow(err);
    });
  });
  ...
  describe("getAllProducts test", () => {
    ...
    test("reject error if selected Model does not exists ", async () => {
      ...
      await expect(
        productDAO.getAllProducts("model", "", "NotExistingModel")
      ).rejects.toThrow(err);
    });
  ...
  describe("getAllAvailableProducts test:", () => {
    ...
    test("It should return all products with quantity > 0", async () => {
      ...
      const testAvailableProducts: Product[] = [
        testProduct1,
        testProduct2,
        testProduct3,
      ];
    ...
    test("reject error if selected Model does not exists ", async () => {
      ...
      await expect(
        productDAO.getAllAvailableProducts("model", "", "TestModel4")
      ).rejects.toThrow(err);
    });
  ...
  describe("deleteProductByModel tests:", () => {
    ...
    test("it should reject an error if the model specified does not exists", async () => {
      ...
      await expect(
        productDAO.deleteProductByModel("TestModeUnknown")
      ).rejects.toThrow(err);
    });
  });
